"""
pinax block <id> --gate <gate> [--actor …] [--json]

Appends an item.blocked event to the log.
Gate must be one of: scope, decision, destructive, proposal.
...
def run(
    ...
    Appends item.blocked event with the gate type.
    """
